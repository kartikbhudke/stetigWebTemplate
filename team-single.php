...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section class="ls s-py-80 s-py-lg-120 s-py-xl-160 team-single">
				<div class="container">
					<div class="row">
						<div class="offset-lg-1 col-lg-10">
							<div class="row c-gutter-60 align-items-center">
								<div class="col-lg-6 rounded-images">
								...
								<div class="col-lg-6">
									...
									<div class="item-content">
										...
										<p class="social-icons">
											...
											<a href="#" class="fa fa-google color-icon bg-icon rounded-icon" title="google"></a>
								...
								<div class="col-12">
									<div class="entry-content">
										<h5>Biography:</h5>
										<p>
											Doloremque quam. Exercitation totam or cupidatat culpa but autem. In labore so nostrud asper natur officia magna, so quasi. Sit nequeporro dolor Iure. In aperiam vitae suscipit, incidunt and accusantium laboris. In aspernatur and mollit so ullamco. Fusce eros elit, cursus accumsan maximus in, scelerisque eu massa.
										</p>
										<p>
											Aperiam nemo dolores omnis, aliqua error. Quia proident, so dolor. Modi dolor, consequuntur aut eman but ullamco. Magnam. Inventore velit quae or laborum. Incidunt sit. Sequi occaecat dolore yet sed velit mollit but enim. Ipsam fugit and consectetur quia. Explicabo quis quaerat. Reprehen derit. Iste ut yet sequi, and mollit est. Excepteur incidunt.
										</p>
										<h5>Personal Experience</h5>
										<p>
											Doloremque quam. Exercitation totam or cupidatat culpa but autem. In labore so nostrud asper natur officia magna, so quasi. Sit nequeporro dolor Iure. Pellentesque lorem mauris, vehicula vel nulla nec.
										</p>
										<p>
											<div class="row c-gutter-60 mt-20">
												<div class="col-lg-7">
													<span class="small-text fw-700">Internet connection</span>
													<div class="progress">
														<div class="progress-bar bg-danger" role="progressbar" data-transitiongoal="93" aria-valuemin="0" aria-valuemax="100">
															<span>93%</span>
														</div>
													</div>
													<span class="small-text fw-700">IPTV installation</span>
													<div class="progress">
														<div class="progress-bar bg-success" role="progressbar" data-transitiongoal="90" aria-valuemin="0" aria-valuemax="100">
															<span>90%</span>
														</div>
													</div>

													<span class="small-text fw-700">Voip Setup</span>
													<div class="progress">
														<div class="progress-bar bg-info" role="progressbar" data-transitiongoal="98" aria-valuemin="0" aria-valuemax="100">
															<span>98%</span>
														</div>
													</div>

													<span class="small-text fw-700">Sales Managing</span>
													<div class="progress">
														<div class="progress-bar bg-warning" role="progressbar" data-transitiongoal="93" aria-valuemin="0" aria-valuemax="100">
															<span>93%</span>
														</div>
													</div>
												</div>
												...
												<div class="col-lg-5">
													...
													<p>
														Lorem and ex, and incidunt. Ad cons equuntur. Laboriosam conse quatur ad. Ipsa perspiciatis, but laboris and omnis. Excepteur quia totam or cupidatat.
													</p>
												</div>
											</div>
											<h5>Contact Me</h5>
											<form class="team-form c-mb-20 c-gutter-20" method="post" action="/">
												...
												<div class="row">
													...
													<div class="col-sm-6">
														<div class="form-group has-placeholder">
															<label for="topic">Your Topic<span class="required">*</span></label>
															<i class="fa fa-paperclip color-main2"></i>
															<input type="text" aria-required="true" size="30" value="" name="your topic" id="topic" class="form-control" placeholder="Your Topic">
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-sm-12">
														<div class="form-group has-placeholder textarea">
															...
															<i class="fa fa-edit color-main2"></i>
															<textarea aria-required="true" rows="8" cols="45" name="message" id="message" class="form-control" placeholder="Your Message"></textarea>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-sm-12">
														<div class="form-group">
															<button type="submit" id="contact_form_submit" name="contact_submit" class="btn btn-maincolor">
																<span>Submit</span>
															</button>
														</div>
													</div>
