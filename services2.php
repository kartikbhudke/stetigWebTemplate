...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section class="ls s-pt-80 s-pb-50 s-pt-lg-120 s-pb-lg-90 s-pt-xl-160 s-pb-xl-130 c-mb-30 service-page2">
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-12">
							<div class="icon-box rounded text-center hero-bg">
								...
								<h5>
									<a href="service-single.html">Cable TV</a>
								</h5>
								<p>
								...
								<a href="service-single.html" class="small-text service-btn read-more"><span>Read More</span></a>
							</div>
						</div><!-- .col-* -->
						<div class="col-md-6 col-12">
							<div class="icon-box rounded text-center hero-bg">
								...
								<h5>
									<a href="service-single.html">Server</a>
								</h5>
								<p>
									We use strategic marketing tactics that have been proven to work. Social networks, PPC campaigns. We can do it all for Your company!
								</p>
						...
						<div class="col-md-6 col-12">
							<div class="icon-box rounded text-center hero-bg">
								...
								<h5>
									<a href="service-single.html">Internet</a>
								</h5>
								<p>
									We use strategic marketing tactics that have been proven to work. Social networks, PPC campaigns. We can do it all for Your company!
								</p>
