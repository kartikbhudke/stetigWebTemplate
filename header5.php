...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section class="page_topline ds c-my-10 s-py-15 small-text page_title">
					...
					<div class="row align-items-center">
								...
								<li class="dropdown-language">
									<div class="dropdown show">
										<a class="dropdown-toggle" href="#" role="button" id="dropdown-language" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											<img src="images/flags/us.gif" alt="">
											English
										</a>
										<div class="dropdown-menu ls" aria-labelledby="dropdown-language">
											<a href="#"><img src="images/flags/de.gif" alt=""> German</a>
											<a href="#"><img src="images/flags/us.gif" alt=""> English</a>
											<a href="#"><img src="images/flags/fr.gif" alt=""> French</a>
											<a href="#"><img src="images/flags/it.gif" alt=""> Italian</a>
										</div>
									</div>
								</li>
						...
						<div class="col-md-6 text-center text-lg-right">
							<ul class="top-includes border-divided">
								...
								<li>
									<i class="fa fa-phone color-darkgrey px-1"></i> <span>1-800-123-4567</span>
								</li>
							</ul>
						</div>
					</div>
			...
			<header class="page_header ls ms s-bordertop nav-narrow justify-nav-center">
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-xl-12">
